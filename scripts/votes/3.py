...
CHOICES = 7
ASSET_NAMES = ['sfrxETH', 'swETH', 'wstETH', 'ETHx', 'cbETH', 'mevETH', 'rETH']
PREV_WEIGHTS = [2702, 2284, 2261, 1529, 1124, 100, 0]
REDISTRIBUTE = UNIT//10

def main():
    total, votes = read_multiple_choice('votes/3-weight.csv', CHOICES)
